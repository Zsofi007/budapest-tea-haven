...
const AboutTea = () => {
  ...
  return (
    <section id="tea" className="py-24 px-6 bg-secondary/20 relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-emerald-900/6 to-transparent pointer-events-none" />
          ...
          {teaTypes.map((tea, index) => {
            ...
            return (
              <div
                ...
                style={{ 
                  background: 'linear-gradient(135deg, hsl(150, 30%, 16%) 0%, hsl(150, 32%, 14%) 100%)'
                }}
              >
